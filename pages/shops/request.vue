            ...
            <v-card elevation="10" class="rounded-lg">
                <v-card-text>
                    ...
                    <div class="pa-1 border-b-2 mb-4 py-2 border-gray-200">
                        ...
                        <GoogleMap api-key="AIzaSyDHq7ERLIFZX2Mi79e0P_SIi5SL4ujwsw8" :scrollwheel="controls"
                            :zoomControl="true" :fullscreenControl="controls" :mapTypeControl="controls"
                            :streetViewControl="controls" :styles="options" style="width: 100%; height: 200px;"
                    ...
                    <div class="pa-1 border-b-0 mb-4 py-2 border-gray-200">
                        ...
                        <div class="w-100 my-4 space-y-4">
                            <div class="flex justify-between">
                                ...
                                <v-select :items="zones" v-model="selectedZone" variant="outlined" density="compact"
                                    label="Choose Zone" color="primary" item-title="text" item-value="value"></v-select>
                            </div>
                        </div>
                    </div>
                    <v-card-actions class="justify-content-end">
                        <v-btn @click="showDetails = false" color="error" variant="outlined">Cancel</v-btn>
                        <v-btn @click="approveShop(shop.id)" color="success" :disabled="selectedZone===''" variant="flat">Approve</v-btn>
                    </v-card-actions>
                </v-card-text>
            </v-card>
        </v-col>
